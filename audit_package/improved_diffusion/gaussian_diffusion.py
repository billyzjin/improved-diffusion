...
def get_named_beta_schedule(schedule_name, num_diffusion_timesteps,
    ...
    if schedule_name == "linear":
        ...
        # Requires geometric_beta1 > 0 and geometric_alpha_bar_T > 0.
        T = num_diffusion_timesteps
        beta_1 = geometric_beta1
        alpha_bar_T_val = geometric_alpha_bar_T
        assert beta_1 > 0, "geometric schedule requires geometric_beta1 > 0"
        assert 0 < alpha_bar_T_val < 1, "geometric schedule requires 0 < geometric_alpha_bar_T < 1"
