...
echo "=========================================="
echo "SUBMITTING 6 FASHION-MNIST GEOMETRIC EXPERIMENTS"
echo "=========================================="
...
for obj in simple hybrid vlb; do
    for endpt in linear cosine; do
        ...
        JOB=$(sbatch --export=EXPERIMENT=$exp \
            ...
            train_fashionmnist_no_mpi.slurm | awk '{print $4}')
        echo "  ${exp}: $JOB"
    done
done

echo ""
echo "All 6 Fashion-MNIST geometric training jobs submitted."
